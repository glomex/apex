...
```
curl https://raw.githubusercontent.com/glomex/apex/master/install.sh | sh
```

Note that you may need to run the `sudo` version below, or alternatively chown `/usr/local`:
```
curl https://raw.githubusercontent.com/glomex/apex/master/install.sh | sudo sh
```

On Windows download [binary](https://github.com/glomex/apex/releases).
